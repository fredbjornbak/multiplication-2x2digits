...
const MultiplicationHelp = ({ open, onOpenChange, factor1, factor2, problem }: MultiplicationHelpProps) => {
  ...
  // Check if either factor contains a 0 (like 10, 20, 30, etc.)
  const hasZero = factor1.toString().includes('0') || factor2.toString().includes('0');
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          {hasZero ? (
            /* Show only Basic Equation for problems with zeros */
            ...
            /* Show all 5 strategies for problems without zeros */
            <>
